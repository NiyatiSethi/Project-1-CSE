...
A small, user-friendly application is needed to store and manage faculty data efficiently.
...
The scope includes:  
- A GUI interface for entering, viewing, updating, and deleting faculty information  
- A backend SQLite database to store data permanently  
...
The system is intended for users with basic computer knowledge.
